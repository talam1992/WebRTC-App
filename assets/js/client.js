...
connection.onmessage = function(msg) {
    ...
    switch(data.type) {
        case "login":
            ...
            break;
        case "offer":
            call_status.innerHTML = '<div class="calling-status-wrap card black white-text"> <div class="user-image"> <img src="assets/images/user1.jpg" class="caller-image circle" alt=""> </div> <div class="user-name">'+ data.name +'</div> <div class="user-calling-status">Calling...</div> <div class="calling-action"> <div class="call-accept"><i class="material-icons green darken-2 white-text audio-icon">call</i></div> <div class="call-reject"><i class="material-icons red darken-3 white-text close-icon">close</i></div> </div> </div>';
...
call_btn.addEventListener("click", function(){
    ...
    call_status.innerHTML = '<div class="calling-status-wrap card black white-text"> <div class="user-image"> <img src="assets/images/user2.jpg" class="caller-image circle" alt=""> </div> <div class="user-name">'+ call_to_username +'</div> <div class="user-calling-status">Calling...</div> <div class="calling-action"> <div class="call-reject"><i class="material-icons red darken-3 white-text close-icon">close</i></div> </div> </div>';
    var call_reject = document.querySelector('.call-reject');
    call_reject.addEventListener("click", function () {
        call_status.innerHTML = '';
        alert('Call is rejected');
    ...
    if(success === false) {
        ...
        navigator.getUserMedia({
            ...
            dataChannel.onmessage = function (event) {
                chatArea.innerHTML += "<div class='left-align' style='display:flex;align-items:center;'><img src='assets/images/user2.jpg' style='height:40px;width:40px;' class='caller-image circle'><div style='font-weight:600;margin:0 5px;'>" + connected_user + "</div>: <div>" + event.data + "</div></div><br/>";
            }
...
msgSendBtn.addEventListener("click", function (event) {
    ...
    chatArea.innerHTML += "<div class='right-align' style='display:flex; align-items:center; align-self:flex-end;'><div>" + msgVal + "</div>:<div style='font-weight:600;margin:0 5px;'> " + name + "</div><img src='assets/images/user1.jpg' style='height:40px;width:40px;' class='caller-image circle'></div><br/>";
